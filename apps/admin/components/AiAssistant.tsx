          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-5">
              {tab === 'generate' && (
                <GeneratePagePanel
                  pageTitle={pageTitle}
                  onAppend={onAppendBlocks ?? (() => undefined)}
                  onReplace={onReplaceBlocks ?? (() => undefined)}
...
function GeneratePagePanel({
  ...
  return (
    <div className="space-y-4">
      ...
      {preview && (
        <div className="border border-ink/10 bg-surface-50 p-3 space-y-2">
          <p className="text-xs uppercase tracking-widest text-muted">
            {preview.length} blocks generated
          </p>
